...
convertToMetres = height / 100 # Converting our cm value to m^2 for BMI formula

BMI = ((weight / (convertToMetres*convertToMetres)))  # now calculating the BMI based on given formula from question.

print ('Your BMI is {:.2f}'.format(BMI))  # Giving the user their BMI based on input values, rouding to two decimal places as per the example
